...
function Page() {
  ...
  useEffect(() => {
    // Update password validations as the user types
  ...
  const handleRegister = async (e) => {
    ...
    if (!validatePassword(password)) {
      ...
      toast.error("Password criteria didnot matched");
      return;
    }
    ...
    <>
      <section className="bg-white">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section className="relative flex items-end h-32 mt-0 bg-gray-900 lg:-mt-20 lg:col-span-5 lg:h-full xl:col-span-6">
            <img
              alt=""
