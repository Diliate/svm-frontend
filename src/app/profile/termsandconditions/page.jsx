  ...
  return (
    <section className="p-5">
      ...
      <div className="flex items-center justify-center gap-5 mt-5">
        <div className="w-[80%] flex flex-col gap-5 text-justify  text-xl leading-10">
          <p>
            Welcome to [Your Ayurvedic Medicine Website]. By accessing or using
            ...
            site or purchasing our products. If you do not agree with these
            terms, you should not use our services.
          </p>
          <p className="pb-5 border-b-2">
            By using [Your Ayurvedic Medicine Website], you agree to our terms
            and conditions. You must be 18 or older to make purchases, and all
            users must comply with applicable laws. We strive to provide
            accurate product information, but cannot guarantee it is error-free.
            Our products are not intended to diagnose, treat, cure, or prevent
            any disease, so please consult a healthcare professional before use.
            Prices are subject to change, and all orders are subject to
            acceptance. Shipping times are estimates, and we are not responsible
            for delays. Returns and refunds are handled according to our policy,
            and refunds will be issued to the original payment method. You are
