      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="w-[80%]">
          ...
          <div className="flex flex-col gap-3 mt-10">
            ...
            <p className="text-xl leading-10">
              At [Your Ayurvedic Medicine Website], we believe in the power of
              Ayurveda to transform lives. Our goal is to support your wellness
              journey with top-quality products and exceptional customer
              service. Your satisfaction is our priority, and we are here to
              ensure you have a positive experience every time you shop with us.
            </p>
